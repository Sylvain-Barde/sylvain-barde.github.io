...
description: Placeholder for blog posts
tags: formatting code
categories: sample-posts
pseudocode: true
---

This post is simply a placeholder for the blog posts, to ensure that the `_posts` folder is not empty. It is taken from the examples provided in the `al-folio` template.
